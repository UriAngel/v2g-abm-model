...
def main() -> None:
    ...
    ax.set_title("UK tariffs over 24 hours", fontsize=16, fontweight="bold", loc="center")
    ax.legend(loc="upper center", bbox_to_anchor=(0.5, -0.10), ncol=2, fontsize=12, framealpha=0.95)
